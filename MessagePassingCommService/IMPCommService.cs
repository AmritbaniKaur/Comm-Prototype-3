...
namespace MessagePassingComm
{
    ...
    {
        public const string fileStorage = "../../../Storage/ClientFileStore";
    ...
    {
        public const string fileStorage = "../../../Storage/ServiceFileStore";
        public static string baseAddress { get; set; }
    }
    ...
    public class CommMessage
    {
        ...
        /*----< constructor requires message type >--------------------*/
        public CommMessage(MessageType type, string to, string from, string author, Command command)
        {
            this.type = type;
            this.to = to;
            this.from = from;
